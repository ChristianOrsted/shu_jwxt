...
-- 每个学期都配齐四类业务窗口（选课/退课/成绩录入/成绩公布）。
-- 当前学期（term 4）的选课/退课窗口覆盖整个学期，保证演示期间随时可选可退。
INSERT INTO BusinessWindows (window_id, term_id, window_type, start_time, end_time) VALUES
-- 当前学期（2025-2026学年第二学期，2026-02-24 ~ 2026-07-05）
(1, 4, '选课', '2026-02-18 09:00:00', '2026-07-05 22:00:00'),
(2, 4, '退课', '2026-02-18 09:00:00', '2026-07-05 22:00:00'),
(3, 4, '成绩录入', '2026-06-01 09:00:00', '2026-07-10 22:00:00'),
(4, 4, '成绩公布', '2026-06-10 09:00:00', '2026-07-20 22:00:00'),
-- 2024-2025学年第一学期（2024-09-01 ~ 2025-01-18）
(5, 1, '选课', '2024-08-25 09:00:00', '2024-09-15 22:00:00'),
(6, 1, '退课', '2024-08-25 09:00:00', '2024-09-29 22:00:00'),
(7, 1, '成绩录入', '2025-01-04 09:00:00', '2025-01-19 22:00:00'),
(8, 1, '成绩公布', '2025-01-11 09:00:00', '2025-02-01 22:00:00'),
-- 2024-2025学年第二学期（2025-02-24 ~ 2025-07-05）
(9, 2, '选课', '2025-02-17 09:00:00', '2025-03-10 22:00:00'),
(10, 2, '退课', '2025-02-17 09:00:00', '2025-03-24 22:00:00'),
(11, 2, '成绩录入', '2025-06-21 09:00:00', '2025-07-06 22:00:00'),
(12, 2, '成绩公布', '2025-06-28 09:00:00', '2025-07-19 22:00:00'),
-- 2025-2026学年第一学期（2025-09-01 ~ 2026-01-18）
(13, 3, '选课', '2025-08-25 09:00:00', '2025-09-15 22:00:00'),
(14, 3, '退课', '2025-08-25 09:00:00', '2025-09-29 22:00:00'),
(15, 3, '成绩录入', '2026-01-04 09:00:00', '2026-01-19 22:00:00'),
(16, 3, '成绩公布', '2026-01-11 09:00:00', '2026-02-01 22:00:00');
